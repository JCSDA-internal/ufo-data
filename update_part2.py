...
if __name__ == '__main__':
    ...
    renameVariableInDataFile(workingDir, "specific_humidity", "water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water")
    renameVariableInDataFile(workingDir, "specific_humidity_at_two_meters_above_surface", "water_vapor_mixing_ratio_wrt_moist_air_and_condensed_water_at_2m")
