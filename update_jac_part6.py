...
def _renameVariableInDataFile_(input_file, output_file, old_variable_name, new_variable_name):
    ...
    if (any(old_variable_name in varname for varname in data.variables)):
        ...
        for name, var in src.variables.items():
            thisname = name
            if (old_variable_name in name):
                thisname = name.replace(old_variable_name, new_variable_name)
...
if __name__ == '__main__':
    ...
    # -------------------------------------------------------------------------------
    workingDir = ["./"]
    renameVariableInDataFile(workingDir, "brightness_temperature_jacobian_surface_temperature", "brightness_temperature_jacobian_skin_temperature_at_surface")
